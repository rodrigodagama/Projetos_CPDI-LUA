...
local function salvaPontos ()
	...
	if pasta then 
		-- inclui os dados da pontosTable no arquivo pontos.json codifica para JSON
...
function scene:create( event )
	...
	salvaPontos() -- Salvar os dados atualizados no arquivo Json
...
-- cria um loop de 1 a 10
	for i = 1, 10 do
		...
		if (pontosTable[i]) then
			-- definindo que o espaçamento das pontuações seja uniforme de acordo com o tamanho do numero.
			local yPos = 150 + (i*56)
